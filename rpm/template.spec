...
%global pkg_name turtlebot3_simulations
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-turtlebot3-simulations
Version:        2.3.7
Release:        3%{?dist}
...
%changelog
* Wed Apr 29 2026 Pyo <pyo@robotis.com> - 2.3.7-3
- Autogenerated by Bloom

* Tue Apr 28 2026 Pyo <pyo@robotis.com> - 2.3.7-2
- Autogenerated by Bloom

* Tue Apr 21 2026 Pyo <pyo@robotis.com> - 2.3.7-1
- Autogenerated by Bloom
